...
- Контекст мониторинга: Обработка данных телеметрии, предоставляемой устройствами и модулями.
- Контекст управления домом: Включает процессы первичной регистрации и настройки устройств, а также взаимодействие с базой данных для их регистрации.
...
- Контекст уведомлений: Сервис для обработки, генерации и доставки уведомлений пользователям.
- Сценарии и автоматизация: Пользователи должны иметь возможность создавать и управлять сценариями автоматизации.Этот контекст отвечает за программирование системы для управления различными модулями и устройствами в соответствии с индивидуальными потребностями пользователей.
...
На примере сервисов контроля освещения, управления воротами и сервиса нотификаций реализована диграмма компонентов для сервисов [управления устройствами](/diagrams/component/device_management_service.puml) и сервиса уведомлений [сервис уведомлений](/diagrams/component/notification_service.puml)
